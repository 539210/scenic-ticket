...
INSERT INTO items (item_id, title, category_id, price, discount_rate, status) VALUES
(1, '云岭山国家森林公园', 5, 80.00, 0.00, 1),
(2, '青河峡谷漂流', 4, 120.00, 0.00, 1),
(3, '明州古城墙', 6, 60.00, 0.00, 1),
(4, '海湾水世界', 9, 150.00, 0.00, 1),
(5, '星湖湿地公园', 1, 45.00, 0.00, 1),
(6, '城市观景塔', 10, 98.00, 0.00, 1),
(7, '民俗文化博物馆', 7, 50.00, 0.00, 1),
(8, '欢乐亲子乐园', 8, 110.00, 0.00, 1),
(9, '竹海栈道景区', 5, 70.00, 0.00, 1),
(10, '南山日出观景区', 4, 88.00, 0.00, 1),
(11, '云海索道观景区', 4, 135.00, 0.00, 1),
(12, '花溪湿地科普园', 1, 58.00, 0.00, 1),
(13, '北岸古街夜游区', 6, 90.00, 0.00, 1),
(14, '城市艺术展览馆', 7, 40.00, 0.00, 1),
(15, '星河亲子营地', 8, 128.00, 0.00, 1),
(16, '蓝湾水上运动中心', 9, 168.00, 0.00, 1),
(17, '红枫森林步道', 5, 75.00, 0.00, 1),
(18, '东湖游船码头', 1, 96.00, 0.00, 1),
(19, '老城钟楼文化区', 2, 52.00, 0.00, 1),
(20, '云顶露营观星台', 4, 188.00, 0.00, 1)
ON DUPLICATE KEY UPDATE
    title = VALUES(title),
...
(3, 4, 3, 60.00, 1, 60.00, 0.00, '银行卡', 3, '2026-07-02 11:30:00'),
(4, 5, 4, 150.00, 1, 150.00, 0.00, '微信', 1, '2026-07-02 13:40:00'),
(5, 6, 5, 45.00, 1, 45.00, 0.00, '支付宝', 0, '2026-07-03 08:15:00'),
(6, 7, 6, 98.00, 1, 98.00, 0.00, '银行卡', 1, '2026-07-03 14:25:00'),
(7, 8, 7, 50.00, 1, 50.00, 0.00, '微信', 2, '2026-07-04 15:35:00'),
(8, 9, 8, 110.00, 1, 110.00, 0.00, '支付宝', 1, '2026-07-04 16:45:00'),
(9, 10, 9, 70.00, 1, 70.00, 0.00, '银行卡', 3, '2026-07-05 09:55:00'),
(10, 2, 10, 88.00, 1, 88.00, 0.00, '微信', 1, '2026-07-05 17:05:00'),
(11, 3, 11, 135.00, 1, 135.00, 0.00, '支付宝', 1, '2026-07-06 09:20:00'),
(12, 4, 12, 58.00, 1, 58.00, 0.00, '银行卡', 0, '2026-07-06 10:35:00'),
(13, 5, 13, 90.00, 1, 90.00, 0.00, '微信', 1, '2026-07-06 14:05:00'),
(14, 6, 14, 40.00, 1, 40.00, 0.00, '支付宝', 3, '2026-07-07 11:15:00'),
(15, 7, 15, 128.00, 1, 128.00, 0.00, '银行卡', 1, '2026-07-07 15:50:00'),
(16, 8, 16, 168.00, 1, 168.00, 0.00, '微信', 1, '2026-07-08 09:45:00'),
(17, 9, 17, 75.00, 1, 75.00, 0.00, '支付宝', 2, '2026-07-08 12:30:00'),
(18, 10, 18, 96.00, 1, 96.00, 0.00, '银行卡', 1, '2026-07-08 16:20:00'),
(19, 2, 19, 52.00, 1, 52.00, 0.00, '微信', 3, '2026-07-09 10:10:00'),
(20, 3, 20, 188.00, 1, 188.00, 0.00, '支付宝', 0, '2026-07-09 18:40:00')
ON DUPLICATE KEY UPDATE
